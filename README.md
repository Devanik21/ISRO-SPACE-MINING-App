...
```bash
git clone https://github.com/Devanik21/ISRO-SPACE-MINING-App.git
cd ISRO-SPACE-MINING-App
...
├── pages/3_🧐_Analyze.py
├── pages/4_📊_Visualize.py
